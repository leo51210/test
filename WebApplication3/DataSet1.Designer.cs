...
namespace WebApplication3 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_Orders_Order_Details;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_Orders_Order_Details = this.Relations["FK_Orders_Order Details"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK_Orders_Order_Details = new global::System.Data.DataRelation("FK_Orders_Order Details", new global::System.Data.DataColumn[] {
                        this.tableOrders.OrderIDColumn}, new global::System.Data.DataColumn[] {
                        this.tableOrder_Details.OrderIDColumn}, false);
            this.Relations.Add(this.relationFK_Orders_Order_Details);
        }
        ...
        public partial class Order_DetailsDataTable : global::System.Data.TypedTableBase<Order_DetailsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public Order_DetailsRow AddOrder_DetailsRow(OrdersRow parentOrdersRowByFK_Orders_Order_Details, int ProductID, decimal UnitPrice, short Quantity, float Discount) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        Quantity,
                        Discount};
                if ((parentOrdersRowByFK_Orders_Order_Details != null)) {
                    columnValuesArray[0] = parentOrdersRowByFK_Orders_Order_Details[0];
                }
        ...
        public partial class OrdersRow : global::System.Data.DataRow {
            ...
            public Order_DetailsRow[] GetOrder_DetailsRows() {
                if ((this.Table.ChildRelations["FK_Orders_Order Details"] == null)) {
                    return new Order_DetailsRow[0];
                }
                else {
                    return ((Order_DetailsRow[])(base.GetChildRows(this.Table.ChildRelations["FK_Orders_Order Details"])));
                }
            }
        }
        ...
        public partial class Order_DetailsRow : global::System.Data.DataRow {
            ...
            public OrdersRow OrdersRow {
                get {
                    return ((OrdersRow)(this.GetParentRow(this.Table.ParentRelations["FK_Orders_Order Details"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_Orders_Order Details"]);
                }
            }
        }
...
namespace WebApplication3.DataSet1TableAdapters {
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT COUNT(OrderID) FROM Orders";
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> Order_Count() {
